...
export class UpdateClientComponent implements OnInit {
  ...
  constructor(private clientDialogRef: MatDialogRef<any>, private customerService:CustomersService, @Inject(MAT_DIALOG_DATA) public data: any) { }
  ...
  createClient(){
    ...
    if(this.editClientForm.valid)
    {
      ...
      this.customerService.update(this.data.id,this.editClientForm.value as CustomerInterface).then((res:any)=>{
        this.editClientForm.reset();
        this.onClose();

        this.popUpAlert('',"The client has been successfully update",'success', false);
      });
  ...
  popUpAlert(messageboodskaap: string, icon: any, showConfirmButton: any, showCancelButton:boolean) {
