...
export class CreateClientComponent implements OnInit {
  ...
  client!: any;
  formBuilder: any;
  constructor(private clientDialogRef: MatDialogRef<any>, private customerService:CustomersService) { }
  ...
  createClient(){
    ...
    if(this.addClientForm.valid)
    {
      ...
      this.customerService.add(this.addClientForm.value as CustomerInterface).then((res:any)=>{
        this.addClientForm.reset();
        this.onClose();

        this.popUpAlert('',"The client has been successfully added",'success', false);
      });
  ...
  popUpAlert(headerMessage: string ,message: string, icon : any, showCancelButton : boolean)
  {
